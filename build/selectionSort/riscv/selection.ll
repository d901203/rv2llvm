; ModuleID = 'selection.c'
source_filename = "selection.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @selectionSort(ptr noundef %0, i32 noundef signext %1) #0 {
  %3 = alloca ptr, align 8
...
43:                                               ; preds = %39
  ...
  call void @swap(ptr noundef %47, ptr noundef %51)
  br label %52
...
23:                                               ; preds = %12
  ...
  call void @selectionSort(ptr noundef %9, i32 noundef signext %24)
